...
Let's look at the residuals. Yikes! Heteroscedasticity!
```{r residuals}
resid <- resid(linear_model)

plot(yrly$min_per_9_inn, resid) + abline(0,0)

```



Next time: use tidy models!
I want to make it easier to be sure I'm plotting the residuals correctly. 
